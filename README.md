...
|---------|-------------|------------|
| 🏭 [**Production Planning App**](https://github.com/AnishNaphade/production-planning-app) | AI-powered sewing plan optimizer for production planning | `FastAPI` `Python` `Pandas` `JavaScript` |
| 🌾 [**Crop Disease Detection**](https://github.com/AnishNaphade/Crop-Disease-Detection) | Deep learning model using VGG16 for crop disease classification | `Python` `TensorFlow` `VGG16` `Jupyter` |
...
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=AnishNaphade&theme=tokyo-night&hide_border=true)](https://github.com/AnishNaphade)
